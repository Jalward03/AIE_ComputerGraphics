...
void Mesh::InitialiseQuad()
{
	...
	// Bind the vertext array, this will be our mesh buffer
	glBindVertexArray(m_vao);

	// Bind the vertext buffer
	glBindBuffer(GL_ARRAY_BUFFER, m_vbo);

	// Define the 6 vertices for our two traingles to make a quad,
